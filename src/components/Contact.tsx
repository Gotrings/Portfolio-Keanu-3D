      ...
      <div className="container mx-auto px-6 relative">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            className="h-full"
          >
            <Card className="p-8 glass h-full relative group overflow-hidden">
          ...
          <motion.div
            ...
            className="h-full"
          >
            <Card className="p-8 glass h-full flex flex-col relative group overflow-hidden">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {socialLinks.map((social, index) => (
                      <motion.a
                        ...
                        className={`p-4 bg-muted/50 backdrop-blur-sm rounded-xl text-muted-foreground transition-all duration-300 ${social.color} hover:shadow-lg hover:-translate-y-1 border border-border/50`}
                      >
